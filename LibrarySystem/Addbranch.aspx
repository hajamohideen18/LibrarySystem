<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Addbranch.aspx.cs" Inherits="LibrarySystem.Addbranch" %>
            ...
            <table align="center" class="style1">
                ...
                <tr>
                    <td>
                        &nbsp;</td>
                    <td>
                        <asp:Button ID="btnadd" runat="server" CssClass="btn" onclick="btnadd_Click"  OnClientClick="return Validate();"
                            Text="ADD Branch" />
                    </td>
                </tr>
                <tr>
