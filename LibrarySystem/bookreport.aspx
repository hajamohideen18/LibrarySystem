<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="bookreport.aspx.cs" Inherits="LibrarySystem.bookreport" %>
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Quantites" HeaderText="Qnt" />
                                        <asp:BoundField DataField="AvailableQnt" HeaderText="Availabale" />
                                        <asp:BoundField DataField="RentQnt" HeaderText="Lent" />
                                        <asp:TemplateField HeaderText="View">
                                        <ItemTemplate>
                                        <asp:LinkButton runat="server"  ID="lnkview" Text="View" CommandArgument='<%#Eval("BID") %>' CssClass="lnk"></asp:LinkButton>
                                        </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
